> Archived Docker/VPS deployment reference. Run commands from the repository root. Hostinger managed Node.js deployment is documented in [README-HOSTINGER.md](../README-HOSTINGER.md). The API and client now belong to this repository; old submodule descriptions below are historical.
